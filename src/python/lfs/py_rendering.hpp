...
[[nodiscard]] std::optional<PyTensor> render_from_camera(int camera_index, int width = -1, int height = -1);
...
[[nodiscard]] std::optional<PyTensor> compute_screen_positions_from_camera(int camera_index);
